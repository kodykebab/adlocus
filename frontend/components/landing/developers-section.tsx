...
const codeExamples = [
  {
    label: "Install",
    code: `npm install eax-sdk ethers @cofhe/sdk

# Publisher integration
# Serves privacy-preserving ads
# Earns ATTN tokens per impression`,
  },
  {
    label: "Initialize",
...
await initEAX({
  ...
  {
    label: "Serve Ad",
    code: `import { getAd, renderAd } from 'eax-sdk'

const ad = await getAd()
await renderAd('#ad-slot', ad)

// Impression recorded on-chain
// Publisher earns ATTN tokens`,
  },
];
...
const features = [
  {
    title: "Privacy-first",
    description: "Zero user data exposure via FHE."
  },
  {
    title: "WASM-powered",
    description: "CoFHE runs in-browser via WebAssembly."
  },
  {
  ...
  {
    title: "Open source",
    description: "MIT licensed. Audit the code yourself."
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-12 leading-relaxed">
              The EAX SDK makes it trivial to serve privacy-preserving ads on any website.
              Three lines of code. Zero user data collection.
            </p>
