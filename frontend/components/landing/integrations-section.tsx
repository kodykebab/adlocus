...
const integrations = [
  { name: "Fhenix CoFHE", category: "FHE Coprocessor" },
  { name: "Ethereum", category: "Blockchain" },
  { name: "MetaMask", category: "Wallet" },
  { name: "MobileBERT", category: "ML Model" },
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">
            Powered by cutting-edge cryptography, local machine learning, and battle-tested blockchain infrastructure.
          </p>
        </div>
